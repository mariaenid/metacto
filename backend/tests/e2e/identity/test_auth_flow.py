...
class TestVerifyEmail:
    def test_verifies_user(self, api_client) -> None:
        ...
        response = api_client.post("/v1/auth/verify-email", {"token": record.token}, format="json")
    ...
    def test_reusing_token_returns_410(self, api_client) -> None:
        ...
        response = api_client.post("/v1/auth/verify-email", {"token": token}, format="json")
...
class TestLoginAndRefresh:
    ...
    def test_refresh_rotates_token(self, api_client) -> None:
        ...
        response = api_client.post("/v1/auth/refresh", {"refresh": first_refresh}, format="json")
        assert response.status_code == 200
    ...
    def test_reusing_refresh_returns_401_and_invalidates_family(self, api_client) -> None:
        ...
        rotated = api_client.post("/v1/auth/refresh", {"refresh": first}, format="json")
        # Re-presenting the old refresh token must trigger breach detection.
        response = api_client.post("/v1/auth/refresh", {"refresh": first}, format="json")
        assert response.status_code == 401
