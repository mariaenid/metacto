...
class FeatureRequestListCreateView(APIView):
    ...
    def get(self, request: Request) -> Response:
        ...
        page = list_feature_requests(build_services(), sort=sort, limit=limit, offset=offset)
...
class StatusTransitionView(APIView):
    ...
    def patch(self, request: Request, request_id) -> Response:
        ...
        try:
            ...
            return Response(
                {
                    "detail": "duplicate_of_id required when transitioning to duplicate",
                    "code": "duplicate_requires_target",
                },
                status=status.HTTP_422_UNPROCESSABLE_ENTITY,
            )
